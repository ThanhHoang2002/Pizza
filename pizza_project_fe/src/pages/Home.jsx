...
const Home = () => {
  return (
    <div className='h-[1000px] font-custom'>
      ...
      <div className='footer h-auto bg-[#000000e6] mt-[20px] flex justify-center'>
        <div className=' w-[70%]'>
          <div className='grid grid-cols-5'>
            <div class="MuiGrid-root jss1432 MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-sm-3 MuiGrid-grid-md-2">
              <a href="/order"><h3 className="mt-[20px] mb-[10px] text-[#fdd760] font-semibold uppercase leading-6 text-[13px]">MENU</h3></a>
              <a class="jss1416" href="/order/DISCOUNT90"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px] '>SIÊU DEAL</p></a>
              <a class="jss1416" href="/order/MYBOX_2023"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>MY BOX</p></a>
              <a class="jss1416" href="/order/COMBO"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>COMBO</p></a>
              <a class="jss1416" href="/order/BUY1GET3"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>MUA 1 ĐƯỢC 3</p></a>
              <a class="jss1416" href="/order/CHICKEN_LOVER"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>GHIỀN GÀ</p></a>
              <a class="jss1416" href="/order/PIZZA"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>PIZZA</p></a>
              <a class="jss1416" href="/order/STARTER"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>MÓN KHAI VỊ</p></a>
              <a class="jss1416" href="/order/DRINK"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>THỨC UỐNG</p></a>
            </div>
            <div class="MuiGrid-root jss1432 MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-sm-3 MuiGrid-grid-md-2">
              <a href="/order"><h3 className="mt-[20px] mb-[10px] text-[#fdd760] font-semibold uppercase leading-6 text-[13px]">VỀ CHÚNG TÔI</h3></a>
              <a class="jss1416" href="/order/DISCOUNT90"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>Giới Thiệu</p></a>
              <a class="jss1416" href="/order/MYBOX_2023"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>Tầm nhìn của chúng tôi</p></a>
              <a class="jss1416" href="/order/COMBO"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>Giá trị cốt lõi</p></a>
              <a class="jss1416" href="/order/BUY1GET3"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>Vệ sinh an toàn thực phẩm</p></a>
            </div>
            <div class="MuiGrid-root jss1432 MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-sm-3 MuiGrid-grid-md-2">
              <a href="/order"><h3 className="mt-[20px] mb-[10px] text-[#fdd760] font-semibold uppercase leading-6 text-[13px]">Tìm cửa hàng</h3></a>
              <a class="jss1416" href="/order/DISCOUNT90"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>Miền bắc</p></a>
              <a class="jss1416" href="/order/MYBOX_2023"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>Miền Trung</p></a>
              <a class="jss1416" href="/order/COMBO"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>Miền Nam</p></a>
            </div>
            <div class="MuiGrid-root jss1432 MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-sm-3 MuiGrid-grid-md-2">
              ...
              <a class="jss1416" href="/order/DISCOUNT90"><p className='text-white my-[9px] font-normal leading-5 cursor-pointer text-[12px]'>Cơ hộ nghề nghiệp</p></a>
