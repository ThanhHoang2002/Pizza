      ...
      <div className='w-[960px] h-[487.7px] flex '>
        ...
        <div className='w-[50%] text-center bg-white shadow-lg rounded-r-md '>
          ...
          <div className='text-sm m-[18px]'>
            ...
            <span>
              <Link to='/sign-up' className='text-[rgb(10,128,32)]'> Đăng ký ngay</Link>
            </span>
          </div>
        </div>
